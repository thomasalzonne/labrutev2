...
export default class Fight {
  ...
  generateTimeline() {
    ...
    this.p1.hp > 0
      ? fightTimeline.push({ winner: this.p1 })
      : fightTimeline.push({ winner: this.p2 });
  ...
  generateTurn() {
    ...
    const fastMan =
      this.p1.character.speed > this.p2.character.speed ? this.p1 : this.p2;
    const slowMan =
      this.p1.character.speed > this.p2.character.speed ? this.p2 : this.p1;
    const attacks = [];
